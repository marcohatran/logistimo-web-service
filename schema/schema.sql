...
CREATE TABLE `logistimo`.`DASHBOARD` (
  ...
  `CONF` VARCHAR(24576) NULL DEFAULT NULL,
...
CREATE TABLE `MATERIAL` (
  ...
  `UNAME` varchar(512) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `VERTICAL` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `ARCAT` datetime DEFAULT NULL,
  `ARCBY` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ORDER` (
  ...
  `ARCAT` datetime DEFAULT NULL,
  `ARCBY` varchar(255) DEFAULT NULL,
  `SALES_REF_ID` VARCHAR(100) DEFAULT NULL,
  `OTY` int(1) DEFAULT '1',
  `EDD` datetime DEFAULT NULL,
  `EAD` datetime DEFAULT NULL,
  `NOI` int(11) DEFAULT NULL,
  `CDRSN` varchar(255) DEFAULT NULL,
  `CVT` DATETIME DEFAULT NULL,
  `VVT` DATETIME DEFAULT NULL,
  `PART` BIGINT(20) DEFAULT NULL,
  `SART` BIGINT(20) DEFAULT NULL,
  `TART` BIGINT(20) DEFAULT NULL,
  `PURCHASE_REF_ID` VARCHAR(100) DEFAULT NULL,
  `TRANSFER_REF_ID` VARCHAR(100) DEFAULT NULL,
  `VERSION` BIGINT(20),
  PRIMARY KEY (`ID`),
...
CREATE TABLE `USERTOKEN` (
  ...
  `TOKEN_TYPE` enum('LOGIN', 'BULLETIN_BOARD', 'PERSONAL_ACCESS_TOKEN') DEFAULT 'LOGIN',
...
CREATE OR REPLACE TABLE `STOCK_REBALANCING_EVENT` (
  `id` varchar(255) NOT NULL,
