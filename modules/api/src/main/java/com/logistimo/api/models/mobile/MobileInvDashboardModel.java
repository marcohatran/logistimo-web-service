...
public class MobileInvDashboardModel extends BaseResponseModel implements Serializable {
  ...
  public Long tec = 0l;//total entity count
  public Long aec = 0l;//active entity count
  public Long tc = 0l;//total inventory count
  public Long nc = 0l;// normal inventory count
