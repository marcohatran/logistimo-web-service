...
public class LikeRegisteredEventHandlerTest {
  ...
  public void getUserLocale() throws Exception {
    LikeRegisteredEventHandler eventHandler = new LikeRegisteredEventHandler();
    Locale locale = eventHandler.getReceiversLocale(1L);
