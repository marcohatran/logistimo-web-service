...
var logistimoApp = angular.module('logistimoApp', ['ngCookies', 'ngSanitize', 'ngRoute', 'dashboardControllers', 'dashboardServices',
    ...
    'approvalControllers', 'bulletinBoardControllers', 'logistimo.storyboard', 'eventSummaryServices', 'systemCfgControllers','analyticsServices'
...
logistimoApp.config(function ($routeProvider) {
    ...
    }).when("/dashboard/customdashboard/view/:dashboardId", {
        action: "dashboard.viewcustomdashboard"
