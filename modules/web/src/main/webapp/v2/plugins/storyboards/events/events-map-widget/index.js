...
angular.module('logistimo.storyboard.eventMapWidget', [])
    .config(function (widgetsRepositoryProvider) {
        widgetsRepositoryProvider.addWidget({
            id: "eventMapWidget",
            name: "Event map",
            templateUrl: "plugins/storyboards/events/event-map-widget/events/event-map-widget-widget.html",
            editTemplateUrl: "plugins/storyboards/events/edit-template.html",
            templateFilters: [
                {
