...
/**
 * Created by kumargaurav on 30/09/16.
 */
public interface IMessageDao {
  ...
  Results getMessages(String convId, String objectType, String objectId, PageParams pageParams);

  Results getMessagesCount(String convId, String objectType, String objectId,
                           PageParams pageParams);

  Results getMessagesByTags(List<String> tags, PageParams pageParams);

  String getConversationId(String objectType, String objectId, PersistenceManager pm);
}
