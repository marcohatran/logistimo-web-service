...
public class ReturnsQuantityBuilderTest {

  @InjectMocks
  ReturnsQuantityBuilder returnsQuantityBuilder;

  @Test
  public void testReturnQuantityBuilder()
  {
    ...
    returnsQuantityBuilder.buildReturnsQuantityList(shipmentList,totalReturnsQtyList);
  }
}
