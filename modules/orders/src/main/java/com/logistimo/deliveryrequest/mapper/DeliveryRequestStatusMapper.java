...
package com.logistimo.deliveryrequest.mapper;
...
public interface DeliveryRequestStatusMapper<S extends ExtDeliveryRequestStatus> {
  DeliveryRequestStatus map(S orderStatus);
}