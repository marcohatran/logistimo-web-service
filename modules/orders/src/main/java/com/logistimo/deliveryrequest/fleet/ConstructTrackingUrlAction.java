 ...
 */
@Component("fleetConstructTrackingUrlAction")
public class ConstructTrackingUrlAction implements IConstructTrackingUrlAction {
  @Override
  public String invoke(String trackigId, TransporterDetailsModel
      transporterDetailsModel) {
    return transporterDetailsModel.getUrl().concat(String.format(FleetConstants
        .TRACKING_ENDPOINT, trackigId));
  }
}