...
public interface ITaskLogger {
  ...
  ITask createTask(String queue, String url, long scheduledTime, long domainId, String userName,
                   String taskName);

  void moveToInProgress(Long taskId);

  void complete(Long taskId, long duration);

  void fail(TaskOptions taskOptions, long duration, String reason);
}
